...
import fi.vm.sade.hakemuseditori.tulokset._
import fi.vm.sade.hakemuseditori.valintatulokset.domain.{HakutoiveenValintatulos, Valintatulos, Vastaanottoaikataulu}
