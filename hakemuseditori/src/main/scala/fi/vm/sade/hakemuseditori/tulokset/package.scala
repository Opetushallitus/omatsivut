...
import fi.vm.sade.hakemuseditori.tulokset.HakutoiveenValintatulosTila.HakutoiveenValintatulosTila
import fi.vm.sade.hakemuseditori.tulokset.ResultState.ResultState
import fi.vm.sade.hakemuseditori.tulokset.VastaanotettavuusTila.VastaanotettavuusTila
import fi.vm.sade.hakemuseditori.valintatulokset.domain.HakutoiveenIlmoittautumistila
