...
class LocalQADataRecordedSimulation extends Simulation {
    ...
    exec(http("Get front page")
      ...
      .get( """/omatsivut/api/applications""")
      ...
      .post( """/omatsivut/api/applications/validate/1.2.246.562.11.00000943332""")
      .headers(headers_10)
      ...
      .put("""/omatsivut/api/applications/1.2.246.562.11.00000943332""")
      .body(RawFileBody("SaveApplicationRequest.txt")))
      .exec(http("Preview application")
      .get( """/omatsivut/api/applications/preview/1.2.246.562.11.00000943332""")
      .headers(headers_5))
