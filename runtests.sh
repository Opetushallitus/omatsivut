...
./sbt mocha -java-home $JAVA_HOME -Domatsivut.profile=it-with-valintatulos -Domatsivut.valinta-tulos-service.url=http://localhost:8097/valinta-tulos-service -DJAVA8_HOME=$JAVA8_HOME
result=$?
