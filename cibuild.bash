...
time mvn clean install -U $EXTRA_MAVEN_ARGS -B -Dbranch=${TRAVIS_BRANCH} -Drevision=${TRAVIS_COMMIT} -DbuildNumber=${TRAVIS_BUILD_NUMBER} -Dvalintatulos.it.postgres.port=5432 -Domatsivut.it.postgres.alreadyrunning=true -Domatsivut.it.postgres.port=5432
