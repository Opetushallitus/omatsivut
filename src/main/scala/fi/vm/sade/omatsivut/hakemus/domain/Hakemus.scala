...
case class Hakutoive(val hakemusData: Option[HakutoiveData], hakuaikaId: Option[String], kohdekohtainenHakuaika: Option[KohteenHakuaika])
object Hakutoive {
  def empty = Hakutoive(None, None, None)
}
