  ...
  describe('Hakemuslistaus', function () {
    ...
    describe("Erillishaku ilman hakulomaketta", function() {
      ...
      describe("Tietojen näyttäminen", function() {
        ...
        it("Valintatulokset näytetään", function() {
          expect(erillishaku.valintatulokset()[0].hakukohde).to.equal('Kallion lukio Lukion ilmaisutaitolinja, Kevät 2014, valmis') // <- valinta-tulos-servicellä ei ole kannassaan tätä, mutta se haetaan koulutusInformaatio-APIsta
