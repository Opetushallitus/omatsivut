...
//   PETAR decide what will be the login url. Is it:     location must endWith("shib/omatsivut/initsession?target=" + originalUrl)
        location must endWith("omatsivut/shibboleth/LoginFI")
      }
    }
